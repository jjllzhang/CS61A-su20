...
def add_trees(t1, t2):
    ...
    if is_leaf(t1):
        ...
        fewer_branches_t, more_branches_t = sorted([branches(t1), branches(t2)], key=len)
        pad_t1 = fewer_branches_t + [tree(0) for i in range(len(more_branches_t) - len(fewer_branches_t))]
        pad_t2 = more_branches_t
