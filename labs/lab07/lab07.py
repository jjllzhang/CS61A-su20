...
def make_glookup(class_assignments):
    ...
    """
    "*** YOUR CODE HERE ***"
    current_class_assignments = {}
    for assignment in class_assignments:
        current_class_assignments[assignment] = 0
    def lookup(assignment, score):
        nonlocal current_class_assignments
        current_class_assignments[assignment] = score
        total = 0
        for assignment in current_class_assignments:
            if current_class_assignments[assignment] > 0:
                total += class_assignments[assignment]
        percentage = sum(current_class_assignments.values()) / total
        return percentage
    return lookup
