...
class VendingMachine:
    ...
    """
    "*** YOUR CODE HERE ***"
    def __init__(self, something, price):
    ...
    def vend(self):
        if self.stock == 0:
            ...
            if self.balance == 0:
                return 'Here is your {0}.'.format(self.something)
            else:
                balance = self.balance
                self.balance = 0
                return 'Here is your {0} and ${1} change.'.format(self.something, balance)
    ...
    def restock(self, amount):
        ...
        return 'Current {0} stock: {1}'.format(self.something, self.stock)
...
class Coin:
    ...
    def worth(self):
        "*** YOUR CODE HERE ***"
        passed_times = Mint.current_year - self.year
        if passed_times > 50:
            return self.cents + (passed_times - 50)
        else:
            return self.cents
